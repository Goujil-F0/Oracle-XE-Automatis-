...
-- 1. Insertion des départements(un par un)
...
INSERT INTO projects (project_id, project_name, start_date, budget, status) 
VALUES (seq_project_id.NEXTVAL, 'Migration Cloud', DATE '2024-01-01', 250000, 'ACTIVE');
INSERT INTO projects (project_id, project_name, start_date, budget, status) 
VALUES (seq_project_id.NEXTVAL, 'Application Mobile', DATE '2024-02-01', 150000, 'ACTIVE');
INSERT INTO projects (project_id, project_name, start_date, budget, status) 
VALUES (seq_project_id.NEXTVAL, 'Formation RH', DATE '2024-03-01', 50000, 'PLANNED');

-- 5. Affectation des employés aux projets
INSERT INTO employee_projects (emp_id, project_id, role, hours_allocated) 
VALUES (101, 1000, 'Chef de projet', 160);
INSERT INTO employee_projects (emp_id, project_id, role, hours_allocated) 
VALUES (102, 1000, 'Développeur', 140);
INSERT INTO employee_projects (emp_id, project_id, role, hours_allocated) 
VALUES (101, 1001, 'Architecte', 80);
INSERT INTO employee_projects (emp_id, project_id, role, hours_allocated) 
VALUES (104, 1002, 'Responsable Formation', 100);
